...
public class MainActivity extends AppCompatActivity {
    ...
    private String connectedDevicesString = "";
    private List<BluetoothDevice> connectedDevices;
    private BluetoothDevice connectedDevice;
    private final BluetoothReceiver receiver = new BluetoothReceiver();

    private List<List<String>> alphabets = Arrays.asList(Arrays.asList(
            "",  // Index 0 (empty)
    ...
    public void receiveBluetoothData(String bluetoothData) {
